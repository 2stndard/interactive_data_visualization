...
fig |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-1'))
...
fig_gauge |> layout(grid=list(rows=3, columns=3), 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-3'))
...
plot_ly() |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-9'))
...
plot_ly() |>
  ...
  layout(geo = list(resolution=50, scope = 'asia', 
         ...
         margin = list(r = 0, l = 0, t = 0, b = 0)) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-10'))
...
plot_ly(plot_dat) %>%
  ...
  layout(title = '22년 전국 대학 신입생 충원율', 
         margin = margins_R)  |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-12'))
...
plot_mapbox(plot_dat_seoul) |>
  ...
  layout(title = '서울지역 주요 대학',
         ...
         margin = margins_R, 
         showlegend = FALSE)  |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap6/fig/vector/6-13'))
